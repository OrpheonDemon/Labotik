...
async def create_laboratorista(laboratorista_in: schemas.LaboratoristaCreate, db: AsyncSession = Depends(get_db)):
...
async def update_laboratorista(id_laboratorista: str, laboratorista_in: schemas.LaboratoristaUpdate, db: AsyncSession = Depends(get_db)):
...
async def delete_laboratorista(id_laboratorista: str, db: AsyncSession = Depends(get_db)):
